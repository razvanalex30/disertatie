...
if __name__ == '__main__':
    setLogLevel('info')
    logging.basicConfig(format='%(message)s', filename='/home/razvan/Disertatie/disertatie/TopologiesScripts/user_1/created/TOPO_CREATED3/logfile.log', filemode='a', level=logging.INFO)
    run()