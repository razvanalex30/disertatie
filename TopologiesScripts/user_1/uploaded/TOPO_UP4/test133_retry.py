...
if __name__ == '__main__':
    setLogLevel('info')
    logging.basicConfig(format='%(message)s', filename='/home/razvan/Disertatie/disertatie/TopologiesScripts/user_1/uploaded/TOPO_UP4/logfile.log', filemode='a', level=logging.INFO)
    run()