...
from mininet.log import setLogLevel, lg, output
...
if __name__ == '__main__':
    setLogLevel('info')
    logging.basicConfig(format='%(message)s', filename='/home/razvan/Disertatie/disertatie/TopologiesScripts/user_1/uploaded/TOPO_UP2/logfile.log', filemode='a', level=logging.INFO)
    run()